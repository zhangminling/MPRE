        ...
        <ContentTemplate>
                                <div id="Man_Nav">
                                    <div class="form-group col-xs-3 col-md-3">
                                        <span class="input-icon">
                                            <asp:TextBox ID="SearchTB" runat="server" placeholder="查询报告单" class="form-control input-sm"></asp:TextBox>
                                ...
                                <br />
                                  ...
                                  <div class=" col-xs-10 col-md-10">
                                    ...
                                    <asp:Button ID="DelBtn" runat="server" Text="删除报告单" class="btn btn-warning"
